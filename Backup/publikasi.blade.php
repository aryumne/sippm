                ...
                <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="row card-title">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary text-rose mt-0" data-toggle="modal" data-target="#formPublikasi">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="updatePublikasi{{$publik->id}}" tabindex="-1" role="dialog" aria-labelledby="updatePublikasi{{$publik->id}}" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Form Ubah Data Publikasi</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form class="form" id="EditPublikasiValidation" action="{{ route('publikasi.update', $publik->id) }}" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="judul" name="judul" value="{{ old('judul', $publik->judul_jurnal) }}" required>
                                                            </div>
                                                            @error('judul')
                                                            <span id="category_id-error" class="error text-danger" for="input-id" style="display: block;">{{ $message }}</span>
                                                            @enderror
                                                            ...
                                                            <div class="form-group" id="dynamic_form">
                                                                <div class="input-group baru-data">
                                                                    ...
                                                                    <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $publik->nama_artikel) }}" required>
                                ...
                                <button type="button" class="btn btn-danger btn-hapus" style="display:none;"><i class="fa fa-times"></i></button>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control selectpicker" data-style="btn btn-link" id="jenis" name="jenis" data-style="btn btn-primary btn-round" required>
                                                                    <option selected>{{ $publik->jenis_jurnal }} {{ old('nama') }}</option>
                                        ...
                                        <a href="" class="btn btn-link btn-danger btn-just-icon remove">
                                            <form class="form" action="{{ route('publikasi.destroy', $publik->id) }}" method="POST" id="DetelePublikasiValidation">
                                                @csrf
                                                @method('DELETE')
...
@section('modal')
<!-- Modal Publikasi -->
<div class="modal fade" id="formPublikasi" tabindex="-1" role="dialog" aria-labelledby="formPublikasi" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form class="form" id="AddPublikasiValidation" action="{{ route('publikasi.store') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="jenis">Jenis Publikasi</label>
                        <select class="form-control selectpicker" data-style="btn btn-link" id="jenis" name="jenis" data-style="btn btn-primary btn-round" required>
                            <option selected>Jenis Publikasi {{ old('nama') }}</option>
                            <option value="Internasional">Internasional</option>
                            <option value="Prosiding Internasional">Prosiding Internasional</option>
                            <option value="Nasional Terakreditasi">Nasional Terakreditasi</option>
                            <option value="Nasional">Nasional</option>
