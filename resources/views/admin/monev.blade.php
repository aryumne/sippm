            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="material-datatables">
                        <table id="datatables-monev" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Reviewer</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('adminpenilaian.monevs.update', $kmj->pivot->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        @endif
                                        <form action="{{ route('adminpenilaian.monevs.destroy', $kmj->pivot->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method("DELETE")
...
<div class="modal fade" id="formKemajuan" tabindex="-1" role="dialog" aria-labelledby="formProposal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="AddPenilaianValidation" action="{{ route('adminpenilaian.monevs.store') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select multiple class="form-control selectpicker" data-size="10" title="multiple select" data-style="btn btn-link" id="lap_kemajuan_id" name="lap_kemajuan_id[]" required>
