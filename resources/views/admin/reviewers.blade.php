            ...
            <div class="card">
                <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="row card-title">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="button" class="btn btn-rose btn-round mt-0" data-toggle="modal" data-target="#addReviewer">
                ...
                <div class="card-body">
                    <div class="material-datatables">
                        <table id="datatables-reviewers" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            <thead>
                                <tr>
                                    <th>NIDN</th>
                                    <th>Nama</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($rvw->role_id == 2)
                                        <form action="{{ route('admin.reviewers.update', $rvw) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-sm">Nonaktif</button>
                                        </form>
                                        @else
                                        <form action="{{ route('admin.reviewers.update', $rvw) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-info btn-sm">Aktif</button>
                                        </form>
                                        @endif
                                    </td>
                                </tr>
        ...
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                    <form id="AddReviewerValidation" class="form" method="POST" action="{{ route('admin.reviewers.store') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <div class="col-10 px-0">
                                        <select class="form-control " data-color="rose" id="choices-tags" name="nidn" required>
                                            @foreach ($dosen as $ds)
                                ...
                                @error('nidn')
                                <span id="category_id-error" class="error text-danger pl-3" for="input-id" style="display: block;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
