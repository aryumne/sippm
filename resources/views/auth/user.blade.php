                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group bmd-form-group is-filled">
                                                <select class="form-control selectpicker" data-style=" btn btn-link"
                                                    name="jabatan" id="jabatan_id">
                                                    @foreach ($jabatan as $k)
                                                        <option value="{{ $k->id }}"
                                                            {{ $k->id == $d->jabatan_id ? 'Selected' : '' }}>
                                                            {{ $k->nama_jabatan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('user.update', Auth::user()->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group bmd-form-group is-filled">
                                            <input class="form-control form-password" name="current_password"
                                                id="current_password" type="password"
                                                value="{{ old('current_password') }}" required="true"
                                                aria-required="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group bmd-form-group is-filled">
                                            <input class="form-control form-password" name="password" id="password"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group bmd-form-group is-filled">
                                            <input class="form-control form-password" name="password_confirm"
                                                id="password_confirm" type="password" required="true" aria-required="true"
                                                onChange="onChange()">
