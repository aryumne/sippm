            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pt-2 px-md-3">
                        <form class="form" id="AddLuaranHKI" action="{{route('luaran-hki.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row py-2">
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control selectpicker" data-style="btn btn-link" id="jenis_hki_id" name="jenis_hki_id" data-style="btn btn-primary btn-round" required>
                                        ...
                                        <option value="{{ $jenis->id }}" {{ old('jenis_hki_id') == $jenis->id ? 'Selected' : ''}}>
                                            {{ $jenis->hki }}
                                        </option>
                                        @endforeach
                                    </select>
