    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            @if (Auth::user()->role_id <= 2) <li
                ...
                <li
                    class="nav-item {{ request()->routeIs('dosen.*') ||request()->routeIs('faculty.*') ||request()->routeIs('prodi.*') ||request()->routeIs('jabatan.*') ||request()->routeIs('sumberDana.*') ? 'active': '' }}">
                    ...
                    <div class="collapse {{ request()->routeIs('dosen.*') ||request()->routeIs('faculty.*') ||request()->routeIs('prodi.*') ||request()->routeIs('jabatan.*') ||request()->routeIs('sumberDana.*')? 'show': '' }}"
                        id="master">
                        <ul class="nav">
