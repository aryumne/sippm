                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="editsumberDana{{ $j->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form" action="{{ route('sumberDana.update', $j->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="sumber">Nama Sumber
                                                                    Dana</label>
                                                                <input type="text" class="form-control pt-4" id="sumber"
                                                                    name="sumber"
                                                                    value="{{ old('sumber', $j->sumber) }}" required>
                                                                @error('sumber')
