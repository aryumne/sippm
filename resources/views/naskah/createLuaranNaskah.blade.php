            ...
            <div class="card">
                <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="row card-title">
                        <div class="col-12">
                            <h4 class="fw-400">Tambah Luaran Naskah Akademik</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="pt-2 px-md-3">
                        <form class="form" id="AddLuaranNaskah" action="{{route('luaran-naskah.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row py-2">
                            ...
                            <div class="row py-2">
                                <div class="col-md-3 pt-2">
                                    <label class="label-control">Tahun Penyusunan Naskah</label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control selectpicker" data-style="btn btn-link" id="peruntukan_id" name="peruntukan_id" data-style="btn btn-primary btn-round" required>
                                        ...
                                        <option value="{{ $jenis->id }}" {{ old('peruntukan_id') == $jenis->id ? 'Selected' : ''}}>
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group form-file-upload form-file-multiple" id="unggah_artikel">
                                        <input type="file" name="path_naskah" class="inputFileHidden" required>
