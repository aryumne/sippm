            ...
            <div class="card">
                <div class="card-header card-header-warning card-header-icon">
                    ...
                    <div class="row card-title">
                        <div class="col-12">
                            <h4 class="fw-400">Edit Naskah Akademik</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="pt-2 px-md-3">
                        <form class="form" id="EditLuaranNaskah" action="{{route('luaran-naskah.update', $lapNaskah->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row py-2">
                                <div class="col-md-3 pt-2">
                                    <label class="label-control">Judul Naskah</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control pl-2" value="{{ old('judul', $lapNaskah->judul)}}" name="judul" id="judul" required />
                                    @error('judul')
                            ...
                            <div class="row py-2">
                                <div class="col-md-3 pt-2">
                                    <label class="label-control">Tahun Penyusuan Naskah</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="year" class="form-control pl-2" value="{{ old('tahun', $lapNaskah->tahun)}}" name="tahun" id="tahun" required />
                                    @error('tahun')
                                    <span id="category_id-error" class="error text-danger" for="input-id" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row py-2">
                                <div class="col-md-3 pt-2">
                                    <label class="label-control">Peruntukan Naskah</label>
                                </div>
                                <div class="col-md-9">
                                    <select class="form-control selectpicker" data-style="btn btn-link" id="peruntukan_id" name="peruntukan_id" data-style="btn btn-primary btn-round" required>
                                        <option disabled selected>Pilih Jenis Peruntukan</option>
                                        @foreach ($peruntukans as $jenis)
                                        <option value="{{ $jenis->id }}" {{ old('peruntukan_id', $lapNaskah->peruntukan_id) == $jenis->id ? 'Selected' : ''}}>
                                            {{ $jenis->nama_peruntukan }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('peruntukan_id')
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-md-9">
                                    ...
                                    {{-- cek intern ketua ada atau tidak
                                        ...
                                        --}}
                                    @foreach ($lapNaskah->timIntern as $internKetua)
                                    ...
                                    @foreach ($lapNaskah->timExtern as $externKetua)
                                ...
                                <div class="col-md-9">
                                    <div id="nidn_anggota">
                                        <select multiple class="form-control" data-size="10" data-color="rose" id="choices-tag-anggota" name="nidn_anggota[]">
                                            ...
                                            <option value="{{ str_pad($dsn->nidn, 10, '0', STR_PAD_LEFT) }}" @foreach ($lapNaskah->timIntern as $internAnggota)
                                    ...
                                    <div class="row" id="anggota_luar">
                                        <div class="col-12" id="listAnggotaLuar">
                                            ...
                                            @foreach ($lapNaskah->timExtern as $externAnggota)
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group form-file-upload form-file-multiple" id="unggah_artikel">
                                        <input type="file" name="path_naskah" class="inputFileHidden">
                                        <div class="input-group">
                                            <input type="text" id="path_naskah" class="form-control inputFileVisible" placeholder="single file">
                            ...
                            <div class="row px-2 justify-content-between">
                                <a href="{{ route('luaran-naskah.index') }}" class="btn btn-secondary text-rose">Batal</a>
