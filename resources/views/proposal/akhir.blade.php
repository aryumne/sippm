                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="EditLapKemajuan{{ $akhr->id }}" tabindex="-1"
...
<div class="modal fade" id="formAkhir" tabindex="-1" role="dialog" aria-labelledby="formProposal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form class="form" id="AddAkhirValidation" action="{{ route('laporan-akhir.store') }}" method="POST"
