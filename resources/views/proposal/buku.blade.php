                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="ubahBuku{{ $b->id }}" tabindex="-1" role="dialog"
                                            aria-labelledby="ubahBuku{{ $b->id }}" aria-hidden="true">
                                                    ...
                                                    <form class="form" id="EditBukuValidation"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group pt-2">
                                                                <label for="judul" class="bmd-label-floating pt-2">Judul
                                                                    Buku</label>
                                                                <input type="text" class="form-control" id="judul"
                                                                    name="judul"
                                                                    value="{{ old('judul', $b->judul_buku) }}" required>
                                                            </div>
                                                            @error('judul')
                                                            <span id="category_id-error" class="error text-danger"
                                                                for="input-id" style="display: block;">{{ $message
                                                            ...
                                                            <div class="form-group text-left">
                                                                ...
                                                                <input type="text" class="form-control" id="isbn"
                                                                    name="isbn" value="{{ old('isbn', $b->isbn) }}">
                                                            </div>
                                                            @error('isbn')
                                                            <span id="category_id-error" class="error text-danger"
                                                                for="input-id" style="display: block;">{{
                                                                $message }}</span>
                                                            @enderror
