            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="material-datatables">
                        <table id="datatables-hki" class="table table-striped table-no-bordered table-hover"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="ubahHaki{{ $h->id }}" tabindex="-1" role="dialog"
                                            aria-labelledby="ubahHaki{{ $h->id }}" aria-hidden="true">
                                        ...
                                        {{-- <a href="" class="btn btn-link btn-danger btn-just-icon remove">
                                            <form class="form" action="{{ route('hki.destroy', $h->id) }}" method="POST"
