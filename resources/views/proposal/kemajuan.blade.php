                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="EditLapKemajuan{{ $lap->id }}" tabindex="-1"
...
<div class="modal fade" id="formKemajuan" tabindex="-1" role="dialog" aria-labelledby="formProposal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="AddKemajuanValidation" action="{{ route('laporan-kemajuan.store') }}" method="POST"
