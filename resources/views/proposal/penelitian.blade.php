                ...
                <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="row card-title">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="button" class="btn btn-rose btn-round mt-0" data-toggle="modal" data-target="#formKegiatan">
                    ...
                    <div class="toolbar mb-3 px-3">
                        <div class="card-collapse">
                            ...
                            <div id="collapseOne" class="collapse {{ request('tahun_kegiatan') != null || request('faculty_id') != null || request('sumber_dana') != null? 'show': '' }}" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
                                <div class="card-body">
                                    <form action="{{ route('kegiatan.index', 'penelitian') }}" method="GET">
                                        @csrf
                        ...
                        <div class="row py-2 align-items-center bg-light">
                            ...
                            <div class="col-md-9 col-sm-7 pl-md-0">
                                <h5 class="fw-500 pt-3">
                                    {{ 'Rp ' . number_format($penelitian->sum('jumlah_dana'), 2, ',', '.') }}
                                </h5>
                            </div>
                        </div>
                        @endif
        ...
        <div class="modal-content">
            ...
            <form class="form" id="AddKegiatan<alidation" action="{{ route('kegiatan.store') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="jenisKegiatan" value="1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control dana" id="dana" name="dana" value="{{ old('dana') }}" required>
                    </div>
                    @error('dana')
                    <span id="category_id-error" class="error text-danger" for="input-id" style="display: block;">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select multiple class="form-control" data-size="10" title="Pilih Anggota" data-color="rose" id="choices-anggota" name="nidn_anggota[]">
                            @foreach ($dosen as $ds)
