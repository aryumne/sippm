                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="ubahKegiatan{{ $p->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="ubahKegiatan{{ $p->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form" id="EditKegiatan<alidation"
                                                        action="{{ route('kegiatan.update', $p->id) }}" method="POST"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="dana" class="bmd-label-floating pt-2">Jumlah
                                                                    Dana</label>
                                                                <input type="text" class="form-control dana" id="dana"
                                                                    name="dana"
                                                                    value="{{ old('dana', $p->jumlah_dana) }}" required>
                                                            </div>
                                                            @error('dana')
                                                            <span id="category_id-error" class="error text-danger"
                                                                for="input-id" style="display: block;">{{ $message
                                                            ...
                                                            <div class="form-group text-left">
                                                                ...
                                                                <select class="form-control selectpicker"
                                                                    ...
                                                                    <option value="{{ $SD->id }}" {{ $p->sumber_id ==
                                                                        $SD->id ? 'Selected' : '' }}>
                                                                        {{ $SD->sumber }}
                                                                    </option>
                                                                    @endforeach
...
<div class="modal fade" id="formKegiatan" tabindex="-1" role="dialog" aria-labelledby="formKegiatan" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="AddKegiatan<alidation" action="{{ route('kegiatan.store') }}" method="POST"
                enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="jenis_kegiatan" value="1">
