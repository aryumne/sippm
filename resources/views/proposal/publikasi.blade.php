                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="updatePublikasi{{ $publik->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="updatePublikasi{{ $publik->id }}"
                                            aria-hidden="true">
                                                        ...
                                                        <form class="form" id="EditPublikasiValidation"
                                                            ...
                                                            <div class="form-group pt-2" id="dynamic_form">
                                                                <div class="input-group baru-data">
                                                                    <label for="nama" class="bmd-label-floating">Nama
                                                                        Artikel</label>
                                                            ...
                                                            <div class="form-group text-left">
                                                                ...
                                                                <select class="form-control selectpicker"
                                                                    data-style="btn btn-link" id="jenis" name="jenis"
                                        ...
                                        {{-- <a href="" class="btn btn-link btn-danger btn-just-icon remove">
                                            <form class="form" action="{{ route('publikasi.destroy', $publik->id) }}"
...
<div class="modal fade" id="formPublikasi" tabindex="-1" role="dialog" aria-labelledby="formPublikasi"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="AddPublikasiValidation" action="{{ route('publikasi.store') }}" method="POST"
