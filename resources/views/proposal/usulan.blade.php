                    ...
                    <div class="card-header card-header-text card-header-info">
                        ...
                        <div class="row card-title">
                            ...
                            <div class="col-md-6 text-right">
                                <button type="button" class="btn btn-rose btn-round mt-0" data-toggle="modal" data-target="#formProposal">
                        ...
                        <div class="toolbar mb-3 px-3">
                            <div class="card-collapse">
                                <div class="card-header" role="tab" id="headingOne">
                                    <h5 class="mb-0">
                                        <a data-toggle="collapse" href="#collapseOne" aria-expanded="{{ request('tahun_usul') != null || request('faculty_id') != null ? 'true' : 'false' }}" aria-controls="collapseOne" class="collapsed">
                                            Filter data
                                            <i class="material-icons">filter_alt</i>
                                        </a>
                                    </h5>
                                </div>
                                <div id="collapseOne" class="collapse {{ request('tahun_usul') != null || request('faculty_id') != null ? 'show' : '' }}" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
                                    <div class="card-body">
                                        <form action="{{ route('usulan.index') }}" method="GET">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-9 px-0">
                                                    <div class="form-group m-0">
                                                        <input type="year" class="form-control pl-3" id="onlyYear" value="{{ request('tahun_usul') }}" name="tahun_usul" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                            ...
                            <table id="datatables-usulan" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ asset('storage/' . $lap->path_proposal) }}" target="_blank" class="badge badge-success">download</a>
                                        </td>
                                        <td class="text-right">
            ...
            <form class="form" id="AddProposalValidation" action="{{ route('usulan.store') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" data-size="10" title="Pilih Pengusul" data-color="rose" id="choices-tag-pengusul" name="nidn_pengusul" required>
                            @foreach ($dosen as $ds)
                    ...
                    <div class="form-group">
                        ...
                        <select multiple class="form-control" data-size="10" title="Pilih Anggota" data-color="rose" id="choices-tags" name="nidn_anggota[]" required>
                            @foreach ($dosen as $ds)
