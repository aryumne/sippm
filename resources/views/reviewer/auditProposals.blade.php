            ...
            <div class="card">
                <div class="card-header card-header-text card-header-info">
                    <div class="card-text">
                        ...
                        <p class="card-category">{{ $jadwal->finished_at > now() ? 'Batas waktu penilaian: '.$jadwal->finished_at->format('d M Y') : 'Belum dibuka' }}</p>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ asset('storage/' . $ua->proposal->path_proposal) }}" target="_blank" class="btn btn-sm btn-secondary text-rose">lihat
                                        Proposal</a>
                                </td>
                                <td>
                                    @if ($ua->hasil == null)
                                    @can('penilaian_proposal')
                                    <a href="{{ route('reviewer.audit.form', $ua->id) }}" class="btn btn-sm btn-danger">Belum dinilai</a>
                                    @endcan
                                    @else
                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#detail{{ $ua->id }}">Lihat nilai</button>
                                    <div class="modal fade" id="detail{{ $ua->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="card-footer">
                                                    <button type="button" class="btn btn-secondary text-rose" data-dismiss="modal">Kembali</button>
                                                    @can('penilaian_proposal')
                                                    <a href="{{ route('reviewer.audit.edit', $ua->hasil->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                                    @endcan
                                                </div>
                                            </div>
                                        </div>
