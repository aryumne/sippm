...
@section('customSCript')
    <script>
        ...
        $('#point1').on('click', function() {
            ...
            var point1 = document.getElementById('perumusan').value;
            let p1 = Number(point1);
            var point2 = document.getElementById('peluang').value;
            let p2 = Number(point2);
            var point3 = document.getElementById('metode').value;
            let p3 = Number(point3);
            var point4 = document.getElementById('tinjauan').value;
            let p4 = Number(point4);
            var point5 = document.getElementById('kelayakan').value;
