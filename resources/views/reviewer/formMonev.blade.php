                                                        ...
                                                        <div class="col-3 col-lg-4">
                                                            <div class="form-group">
                                                                <input type="number" class="form-control text-center"
                                                                    name="luaran_wajib" value="" id="luaran_wajib" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="komentar"
                                                            name="komentar_luaran_wajib" rows="3" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-12 col-lg-8 text-center">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3 col-lg-4">
                                                            <div class="form-group">
                                                                <input type="number" class="form-control text-center"
                                                                    name="luaran_tambahan" value="" id="luaran_tambahan"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    <div class="form-group">
                                                        <label for="exampleFormControlTextarea1">Komentar</label>
                                                        <textarea class="form-control" id="komentar"
                                                            name="komentar_luaran_tambahan" rows="3" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-12 col-lg-8 text-center">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3 col-lg-4">
                                                            <div class="form-group">
                                                                <input type="number" class="form-control text-center"
                                                                    name="kesesuaian" value="" id="kesesuaian" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-4">
                                                    <div class="form-group">
                                                        <label for="exampleFormControlTextarea1">Komentar</label>
                                                        <textarea class="form-control" id="komentar"
                                                            name="komentar_kesesuaian" rows="3" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
