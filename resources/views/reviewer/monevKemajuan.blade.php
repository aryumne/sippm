                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ asset('storage/' . $ua->kemajuan->path_kemajuan) }}" target="_blank" class="btn btn-sm btn-secondary text-rose">lihat
                                        Laporan Kemajuan</a>
                                </td>
                                <td>
                                    @if ($ua->hasil == null)
                                    @can('monev_laporan_kemajuan')
                                    <a href="{{ route('reviewer.monev.form', $ua->id) }}" class="btn btn-sm btn-danger">Belum dinilai</a>
                                    @endcan
                                    @else
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="card-footer">
                                                    ...
                                                    <a href="{{ route('reviewer.monev.edit', $ua->hasil->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                                    @endcan
                                                </div>
                                            </div>
                                        </div>
